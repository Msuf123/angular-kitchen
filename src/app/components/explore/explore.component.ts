...
@Component({
  ...
  standalone: true,
  imports: [SearchBarComponent,RecipeCardComponent,ObserverApiDirective,LoadingCardsComponent,SideBarComponent,RouterOutlet,TopBarComponent,ExploreComponent,BottomBarComponent],
