...
export const appConfig: ApplicationConfig = {
  providers: [provideRouter(routes),importProvidersFrom(HttpClientModule),provideCloudinaryLoader('https://res.cloudinary.com/dglvbq5bx'),{provide:url,useValue:production}]
};
